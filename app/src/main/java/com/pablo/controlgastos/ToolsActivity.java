...
public class ToolsActivity extends Activity {
    ...
    private void build(){
        ...
        LinearLayout root=new LinearLayout(this);root.setOrientation(LinearLayout.VERTICAL);root.setBackgroundColor(BG);root.setPadding(dp(18),dp(18),dp(18),dp(28));sc.addView(root);
        TextView title=tv("Herramientas",28,TEXT);title.setTypeface(Typeface.DEFAULT,Typeface.BOLD);root.addView(title);
        TextView sub=tv("Importación, exportación y movimientos recurrentes",14,MUTED);root.addView(sub);
        ...
        TextView note=tv("Esta pantalla mantiene el mismo modo oscuro que el resto de ControlGastos.",13,MUTED);root.addView(note);
        setContentView(sc);
